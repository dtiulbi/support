    ...
    data.forEach((item) => {
      ...
      row.innerHTML = `
        ...
        <td>
          ...
          <button class="delete-btn" data-kodepertemuan="${item.kodepertemuan}" onclick="deleteBimbingan('${item.kodepertemuan}')" ><a href="javascript:;" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-red-500"  title="Delete">
          ...
          <button><a href="javascript:;" class="inline-block ltr:mr-2 rtl:ml-2 hover:text-green-500" title="Edit">
